    ...
    return(
        <>
            ...
            <main className="my-[200px] h-full w-full">
                <div id={"preview"} className="sm:w-full lg:items-center md:items-center sm:items-start xl:items-center md:w-[95%] lg:w-[90%] xl:w-[90%] mx-auto max-[570px]:h-[60vh] h-[75vh] lg:h-[40vh] md:h-[40vh] xl:h-[40vh] flex xl:flex-row lg:flex-row md:flex-row sm:flex-col px-5 my-10">
